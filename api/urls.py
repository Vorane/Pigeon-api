...
from notifications.urls import fcm_urls
...
urlpatterns = [
    ...
    url(r'^notification/', include(fcm_urls)),
    ...
    url(r'^checktransaction/',
        CheckTransaction.as_view(),
        name='check_transaction'),
    url(r'^retrytransaction/',
        RetryTransaction.as_view(),
